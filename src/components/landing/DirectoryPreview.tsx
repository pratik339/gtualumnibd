 ...
 // Sample profiles for preview - these represent the type of people in the network
           ...
           {sampleProfiles.map((profile, index) => (
             ...
             >
               <Card className="h-full border-2 hover:border-primary/30 transition-all duration-300 overflow-hidden group">
                 {/* Top gradient bar */}
                 <div className={`h-2 ${profile.type === 'alumni' ? 'bg-gradient-to-r from-primary to-primary/60' : 'bg-gradient-to-r from-emerald-500 to-emerald-400'}`} />
                 ...
                 <CardContent className="p-5">
                   ...
                   <div className="mt-4 space-y-2">
                     <div className="flex items-center gap-2 text-sm text-muted-foreground">
                       ...
                       <span className="truncate">{profile.role} at {profile.company}</span>
                     </div>
                     <div className="flex items-center gap-2 text-sm text-muted-foreground">
         ...
         >
           <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-6 rounded-2xl bg-card/80 backdrop-blur-sm border border-border/50 shadow-lg">
             ...
             <div className="text-center sm:text-left">
               ...
               <p className="text-sm text-muted-foreground">50+ members and counting</p>
             </div>
